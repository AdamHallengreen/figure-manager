...
class FigureManager:
    def __init__(self, output_dir="figures/", paper_size="A4", file_ext=".pdf", dpi=300, use_latex=True):
    ...
    def _apply_custom_style(self):
        ...
        colors = [
            '#EF476F', '#1082A8', '#FFD166', '#06EFB1', '#08485E', '#FF6F61',
            '#1B998B', '#C6C013', '#5A189A', '#A7C957', '#D4A5A5', '#3D348B'
        ]

        # Cycle through colors only
        # plt.rcParams['axes.prop_cycle'] = cycler('color', colors)
        # Cycle through colors and line styles and markers
        plt.rcParams['axes.prop_cycle'] = cycler('color', colors) + cycler('linestyle', 3*['-', '--', '-.', ':']) + cycler('marker', 2*['o', 's', 'D', '^', 'v', 'x'])
